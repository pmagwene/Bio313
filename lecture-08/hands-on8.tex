...
\usepackage[top=1in, bottom=1in, left=1in, right=1in]{geometry} %% for setting page margins %%
...
\usepackage{hyperref} % hyperref should be the last usepackage
...
\subsection*{A Literature Based Assignment}
