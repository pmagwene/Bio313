...
\usepackage[top=1in, bottom=1in, left=1in, right=1.25in]{geometry} %% for setting page margins %%
...
% 
% \begin{enumerate}
% \item Download |setuptools| from the Python Package Index at \href{http://pypi.python.org/pypi/setuptools}{http://pypi.python.org/pypi/setuptools}. Make sure you get the version that is appropriate for your platform and version of Python. From the command line install setuptools like so:
% \begin{Code}
% sudo sh setuptools-0.6c11-py2.7.egg
% \end{Code}
% 
% \item Use the |easy_install| tool included with setuptools to install biopython.
\begin{Code}
sudo easy_install -f http://biopython.org/DIST/ biopython
\end{Code}


% \subsubsection*{Install \texttt{aatranslate}}
% 
% I've written a short python script called |aatranslate| that we'll use for today's pipeline. This script takes a fasta file with nucleotide sequences and translates those into amino acid sequences.  Download this file from the class wiki, place it in your |~/tmp| directory and make it executable as follows:
% 
% \begin{Code}
% $ chmod +x aatranslate
% \end{Code}
